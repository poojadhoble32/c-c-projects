...
BOOL ProcessInfo::ProcessLog()
{
	...
	sprintf_s(FileName,"E:\pooja %02d_%02d_%02d%s.txt",lt.wHour,lt.wMinute,lt.wDay,month[lt.wMonth-1]);
...
BOOL ProcessInfo::ReadLog(DWORD hr, DWORD min,DWORD date,DWORD month)
{
	...
	LOGFILE fobj;
	FILE *fp;
	sprintf_s(FileName,"E:\pooja %02d_%02d_%02d %s.txt",hr,min,date,montharr[month-1]); 
