...
RegisterClassEx(&wnd);
hwnd=CreateWindow(appName,L"ClipBoard
Viewer",WS_OVERLAPPEDWINDOW,CW_USEDEFAULT,CW_USEDEFAULT,CW_USEDEF
AULT,CW_USEDEFAULT,NULL,NULL,hInstance,NULL);
if(hwnd==NULL)
{
MessageBox(hwnd,L"Create Window Failed",L"Error",MB_OK |
MB_ICONERROR);
return 0;
}
